...
public static class Recursion
{
    ...
    public static void WildcardBinary(string pattern, List<string> results)
    {
        ...
        string patternWith0 = pattern.Substring(0, starIndex) + '0' + pattern.Substring(starIndex + 1);
        string patternWith1 = pattern.Substring(0, starIndex) + '1' + pattern.Substring(starIndex + 1);
